...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    { name: "Instagram", icon: Instagram, href: "https://instagram.com/swiftinvoice" },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Streamline your invoicing process with our modern, secure platform. 
                Join thousands of businesses who trust SwiftInvoice for their billing needs.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">123 Finance Street, Suite 100</span>
              </div>
            </div>
