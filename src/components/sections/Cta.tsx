...
export default function CTA() {
  const stats = [
    { value: "25K+", label: "Businesses", icon: Users },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join thousands of small businesses and freelancers who trust SwiftInvoice 
                to manage their billing. Start creating professional invoices in minutes.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Begin with our free plan, upgrade when you're ready
              </p>
            </div>
